...
function Navbar() {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[2040px] mx-auto px-4'>
      <Link to='/'><h1 className='w-full text-xl font-bold'><img className="object-fit w-1/3" src="../src/assets/ddgs_logo.png" alt="" /></h1></Link>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[80%] h-full border-r border-r-gray-900 bg-[#fff] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        <Link to='/'><h1 className='w-full text-xl font-bold m-4'><img className="object-fit w-1/3" src="../src/assets/ddgs_logo.png" alt="" /></h1></Link>
