    ...
    <div className='w-full py-[6rem] px-4'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          ...
          <div className='border border-black bg-white w-full shadow-md flex flex-col p-4 my-4 rounded-lg'>
              ...
              <Link to='/verpakken' className='bg-red-400 text-center text-white w-[200px] hover:bg-red-500 rounded-md font-medium my-6 mx-auto px-6 py-3'>Meer info</Link>
          </div>
          ...
          <div className='border border-black bg-white w-full shadow-md flex flex-col p-4 my-4 rounded-lg'>
            ...
            <Link to='/opleiden' className='bg-red-400 text-center text-white w-[200px] hover:bg-red-500 rounded-md font-medium my-6 mx-auto px-6 py-3'>Meer info</Link>
          </div>
          ...
          <div className='border border-black bg-white w-full shadow-md flex flex-col p-4 my-4 rounded-lg'>
              ...
              <Link to='/droogijs' className='bg-red-400 text-center text-white w-[200px] hover:bg-red-500 rounded-md font-medium my-6 mx-auto px-6 py-3'>Meer info</Link>
          </div>
      </div>
    </div>
  );
